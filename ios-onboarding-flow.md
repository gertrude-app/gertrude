...
This document describes the complete iOS app onboarding flow for Gertrude parental controls.
Use this as a reference for understanding all paths, states, and decision points.

**Architecture:** TCA (The Composable Architecture) with SwiftUI
**Key Files:**
...
**Entry:** App launch on new device
**Exit:** Running state (connected or not connected)
**Screens:** 19
...
**Entry:** confirmMinorDevice → "No" (not under 18)
**Exit:**
...
**Entry:** offerAccountConnect → "Connect"
**Exit:** connectSuccess (success) or return to offerAccountConnect
...
**Entry:** System authorization fails
**Exit:** Returns to explainTwoInstallSteps (retry)
...
**Entry:** Filter installation fails
**Exit:** Returns to explainInstallWithDevicePasscode (retry)
...
**API Route:** `UnauthedRoute.connectAccountFeatureFlag`
**Current Default:** `isEnabled: false`
