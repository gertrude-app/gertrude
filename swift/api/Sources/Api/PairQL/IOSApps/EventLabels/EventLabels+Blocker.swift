extension EventLabel {
  static func blocker(_ eventId: String) -> String? {
    switch eventId {
    ...
    case "9c7e2dcb": "💳 Dash: supervision checkout initiated"
    ...
    case "04376893": "Migrated block groups to UUIDs"
    ...
    // --- Cross Promo ---
    case "c4f06a92": "⚠ Cross promo dropped: no guaranteed exit"
