...
struct DashboardWidgets_v3: Pair {
  ...
  struct Announcement: PairNestable {
    ...
    var icon: String?
    var html: String
    var action: DashAnnouncement.Action?
  }
...
extension DashboardWidgets_v3: NoInputResolver {
...
) -> [DashboardWidgets_v3.UnlockRequest] {
...
private func recentScreenshots(
  ...
  aws: AWS.Client,
  bucketUrl: String,
) -> [DashboardWidgets_v3.RecentScreenshot] {
