  ...
  public static func fromProcess(mode vaporEnv: Vapor.Environment?) -> Env {
    ...
    return Env(
      ...
      stripe: Stripe(
        ...
        priceIdMedium: processEnv("STRIPE_PRICE_ID_MEDIUM"),
        ...
        portalConfigIdMediumTier: processEnv("STRIPE_PORTAL_CONFIG_ID_MEDIUM_TIER"),
      ),
