...
func delayed(by delay: Duration, _ callback: @Sendable @escaping () -> Void) {
...
struct Vector: Equatable, Identifiable, AdditiveArithmetic, Sendable {
  var x: Double
  var y: Double
  var id: UUID
...
extension View {
  ...
  enum UIUserInterfaceIdiom {
    case unspecified, phone, pad, tv, carPlay, mac, vision
  }
#endif
