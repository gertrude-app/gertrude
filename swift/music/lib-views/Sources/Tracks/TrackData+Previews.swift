...
extension [TrackData] {
  static let previewTracks: [TrackData] = [
    ...
    .init(
      ...
      artworkUrl: URL(
        string: "https://is1-ssl.mzstatic.com/image/thumb/Music124/v4/69/6c/db/696cdbe9-4c20-5149-b999-2a96a25662dc/7320470185339.png/600x600bb.jpg",
      ),
      showsArtwork: false,
    ),
    .init(
      ...
      artist: "Lena Jonsson Trio",
      artworkUrl: URL(
        string: "https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/88/b0/5b/88b05b26-427d-aa23-2515-c2c06914e821/cover.jpg/600x600bb.jpg",
      ),
    ),
    .init(
      id: "6",
    ...
    .init(
      ...
      artist: "Ahlberg, Ek & Roswall",
      artworkUrl: URL(
        string: "https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/e2/54/29/e2542981-4315-57e1-6df7-0785143c4d84/7300343882657.jpg/600x600bb.jpg",
      ),
    ),
    .init(
      id: "10",
      ...
      artist: "Väsen",
      artworkUrl: URL(
        string: "https://is1-ssl.mzstatic.com/image/thumb/Music122/v4/49/3b/11/493b11b6-3bd9-f908-d080-26ebf0000cb9/9fd89cdc-63c4-494a-9354-91ef9fc03222.jpg/600x600bb.jpg",
      ),
      showsArtwork: false,
    ),
    .init(
      ...
      artworkUrl: URL(
        string: "https://is1-ssl.mzstatic.com/image/thumb/Music118/v4/51/81/54/51815402-04b8-f6a3-5227-ed747447f3d5/00731452316127.rgb.jpg/600x600bb.jpg",
      ),
    ),
    .init(
      id: "12",
