...
const Button: React.FC<Props> = (props) => {
  ...
  const buttonClasses = cx(
    ...
    hasLabel
      ...
      : {
          'rounded-[7px] p-1.25': props.size === 'small',
          'rounded-[9px] p-2': props.size === 'medium' || props.size === undefined,
          'rounded-[13px] p-2.75': props.size === 'large',
        },
  );
