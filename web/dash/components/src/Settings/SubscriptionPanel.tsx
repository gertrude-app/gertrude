...
interface Props {
  ...
  billing: GetSubscriptionPanel.Output[`billing`];
...
const SubscriptionPanel: React.FC<Props> = (props) => {
  const { entitlement, primary, secondary, onAction, className } = props;
  ...
  if (view === `compare`) {
    return (
      <div className={cardClasses}>
        ...
        <PlanComparison currentPlan={currentPlan(entitlement)} />
...
function currentPlan(entitlement: Entitlement): CurrentPlan {
