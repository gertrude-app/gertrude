...
{% callout type="warning" title="These supervision instructions are outdated" %}

Gertrude now has a Mac and Windows supervision tool that can supervise an iPhone or iPad
without erasing it. Do not follow the Apple Configurator steps in this guide. We’re
working on updated instructions; for now, begin setup in Gertrude Blocker and follow the
prompts for users 18 or older.
