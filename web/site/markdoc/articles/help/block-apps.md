...
[a "key" to access the internet,](/guides/getting-started-with-gertrude-for-mac#add-public-keychain)
it can't make any network requests at all. For most apps, this makes them pretty much
useless, uninteresting, and safe for kids. It's really only if you have apps that are a
distraction or unsafe even without internet that you need to block them. Or if you leave
your child's internet filter off or suspended for large amounts of time, in that case
blocking apps can be a useful extra safeguard.
