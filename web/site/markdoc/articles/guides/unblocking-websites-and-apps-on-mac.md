...
{% callout type="warning" title="We’re updating this guide" %}

This guide was written for an earlier version of Gertrude. Its core explanation and steps
are still useful, but some interface labels and details may not match the current app.
We’re working on an updated version.
