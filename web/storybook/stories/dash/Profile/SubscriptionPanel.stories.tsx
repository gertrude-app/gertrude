...
import type { GetSubscriptionPanel, SubscriptionPanelAction } from '@dash/types';
...
const baseArgs = {
  billing: {} satisfies GetSubscriptionPanel.Output[`billing`],
  primary: undefined,
  secondary: [],
  availableTiers: [],
};
...
const LightPaid: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `light` },
  billing: { status: `active`, currentPeriodEnd: inDays(18) },
...
const LightPaidTrialUsed: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `light` },
  billing: { status: `active`, currentPeriodEnd: inDays(22) },
  primary: { case: `upgradeSubscriptionTier`, to: `full` },
...
const LightOverdue: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `light` },
  billing: { status: `pastDue`, currentPeriodEnd: inDays(-2) },
...
const FullTrialStandalone: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `fullTrial`, until: inDays(14) },
  primary: { case: `startCheckout`, tier: `full` },
  secondary: [{ case: `startCheckout`, tier: `light` }],
  availableTiers: [`light`, `full`],
...
const FullTrialStandaloneExpiring: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `fullTrial`, until: inDays(2) },
  primary: { case: `startCheckout`, tier: `full` },
  secondary: [{ case: `startCheckout`, tier: `light` }],
  availableTiers: [`light`, `full`],
...
const FullTrialFromLight: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `fullTrial`, until: inDays(11) },
  billing: { status: `active`, currentPeriodEnd: inDays(18) },
  primary: { case: `upgradeSubscriptionTier`, to: `full` },
  secondary: [{ case: `openBillingPortal`, config: `lightTier` }],
  availableTiers: [`full`],
...
const FullTrialFromLapsedLight: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `fullTrial`, until: inDays(9) },
  primary: { case: `reactivateViaCheckout`, tier: `full` },
  secondary: [{ case: `reactivateViaCheckout`, tier: `light` }],
  availableTiers: [`light`, `full`],
  lastPaidTier: `light`,
...
const FullPaid: PanelArgs = {
  ...
  billing: { status: `active`, currentPeriodEnd: inDays(24) },
...
const FullOverdue: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `full` },
  billing: { status: `pastDue`, currentPeriodEnd: inDays(-3) },
  primary: { case: `openBillingPortal`, config: `default` },
  secondary: [],
  availableTiers: [],
  lastPaidTier: `full`,
...
const FullComplimentary: PanelArgs = {
  ...
  primary: undefined,
  secondary: [{ case: `contactSupport`, reason: `complimentary` }],
  availableTiers: [],
};

const FullTrialGraceStandalone: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `fullTrialGrace`, until: inDays(4) },
  primary: { case: `startCheckout`, tier: `full` },
  secondary: [{ case: `startCheckout`, tier: `light` }],
  availableTiers: [`light`, `full`],
...
const FullTrialGraceFromLight: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `fullTrialGrace`, until: inDays(3) },
  billing: { status: `active`, currentPeriodEnd: inDays(20) },
  primary: { case: `upgradeSubscriptionTier`, to: `full` },
  secondary: [{ case: `openBillingPortal`, config: `lightTier` }],
  availableTiers: [`full`],
  lastPaidTier: `light`,
...
const FullTrialGraceFromLapsedLight: PanelArgs = {
  ...baseArgs,
  entitlement: { case: `fullTrialGrace`, until: inDays(2) },
  primary: { case: `reactivateViaCheckout`, tier: `full` },
  secondary: [{ case: `reactivateViaCheckout`, tier: `light` }],
  lastPaidTier: `light`,
