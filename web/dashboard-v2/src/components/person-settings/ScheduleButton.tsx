...
import type { Schedule, TimeOfDay } from '#/lib/mock';
...
const dayEntries: Array<[DayKey, string]> = [
  [`sunday`, `Sun`],
  [`monday`, `Mon`],
  [`tuesday`, `Tue`],
  [`wednesday`, `Wed`],
...
export const ScheduleEditor: React.FC<Props> = ({ schedule, setSchedule }) => {
...
const ScheduleButton: React.FC<Props> = ({ schedule, setSchedule }) => (
  <DropdownMenu
