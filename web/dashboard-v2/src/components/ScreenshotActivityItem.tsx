        ...
        <>
          <div
            className={cx(
              ...
              dragging && dragTargetCorner === `bottomRight` ? `opacity-30` : `opacity-0`,
            )}
          />
          <div
            className={cx(
        ...
        <>
          <div
            className={cx(
              ...
              dragging && dragTargetCorner === `bottomLeft` ? `opacity-30` : `opacity-0`,
            )}
          />
          <div
            className={cx(
              ...
              dragging && dragTargetCorner === `bottomLeft` ? `opacity-100` : `opacity-0`,
            )}
          />
        </>
