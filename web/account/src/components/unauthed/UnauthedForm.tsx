...
const UnauthedForm: React.FC<Props> = ({
  ...
  <form
    onSubmit={onSubmit}
    className="bg-stone-50 xs:bg-white xs:rounded-2xl xs:border border-stone-200 xs:shadow-2xl shadow-stone-500/20 xs:w-96 flex flex-col overflow-hidden min-h-screen xs:min-h-auto"
  >
