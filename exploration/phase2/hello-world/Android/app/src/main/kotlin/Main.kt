...
internal val logger: SkipLogger = SkipLogger(subsystem = "hello.world", category = "HelloWorld")

private typealias AppRootView = HelloWorldRootView
private typealias AppDelegate = HelloWorldAppDelegate
